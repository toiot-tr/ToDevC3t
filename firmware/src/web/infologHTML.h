...
const char Infolog_Html[] PROGMEM = R"rawliteral(
<!DOCTYPE html>
<html lang="tr">
<head>
    <meta charset="UTF-8">
    ...
    <div class="main">
        ...
        <div class="main" id="mainDivid" style="display: none;">
            ...
            <div class="log-container">
                <textarea id="logTextid" class="log-textarea" readonly></textarea>
            </div>
        </div>
    </div>
    <script>
        ...
        function loadData() {
            ...
            const logText = document.getElementById("logTextid");
            logText.value = logData || "Log verisi bulunamadı";
